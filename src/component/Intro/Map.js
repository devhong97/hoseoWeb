                            ...
                            <div className='map_text_box'>
                                <div className='text_box left'>
                                    ...
                                    <div className='map_text_row'>
                                        <div className='map_text'><span>TEL</span>041-354-8558</div>
                                        <div className='map_text'><span>FAX</span>041-354-8558</div>
                                        <div className='map_text'><span>E-MAIL</span>master@ciuc.or.kr</div>
                                    </div>
                                </div>
