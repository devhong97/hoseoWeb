      ...
      <div className="sub_back">
        <div className="sub_banner_area">
          <div className="sub_banner_back">
            ...
            <div className="banner_main_text">CNC/MCT</div>
          </div>
        </div>
        <div className="navi_area">
          <div className="navi_back">
            ...
            <div className="navi_box" onClick={() => handleSelect(2)}>
              <div className="navi_main_text">CNC/MCT</div>
              <div className="navi_arrow"></div>
          ...
          <div className="sub_main_back">
            <div className="vision_container">
              <div className="vision_title_box">
                ...
                <div className="title_text">보유시설 - CNC/MCT</div>
              </div>
              <div className="lecture-room">
                <h2>102호 장비실</h2>
                <div className="cnc-image-container">
                  <div className="image cnc-room-image1"></div>
                  <div className="image cnc-room-image2"></div>
                </div>
                <div className="cnc-image-container">
                  <div className="image cnc-room-image3"></div>
                  <div className="image cnc-room-image4"></div>
                </div>
                <p className="description">
                  주요 시설: 수직밀링머신 5, 범용선반 5, CNC선반 2,
                  수직형머시닝센터 2, 테이블 6, 수납장 2
                </p>
