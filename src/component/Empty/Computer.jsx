      ...
      <div className="sub_back">
        <div className="sub_banner_area">
          <div className="sub_banner_back">
            ...
            <div className="banner_main_text">전산실습실</div>
          </div>
        </div>
        <div className="navi_area">
          <div className="navi_back">
            ...
            <div className="navi_box" onClick={() => handleSelect(2)}>
              <div className="navi_main_text">전산실습실</div>
              <div className="navi_arrow"></div>
          ...
          <div className="sub_main_back">
            <div className="vision_container">
              <div className="vision_title_box">
                ...
                <div className="title_text">보유시설 - 전산실습실</div>
              </div>
              <div className="lecture-room">
                <h2>206호 일반강의실</h2>
                <div className="image-container">
                  <div className="image c-room-image1"></div>
                </div>
                <p className="description">
                  주요 시설: 데스크톱, 전자교탁, 빔프로젝터, 마이크
                </p>
              ...
              <div className="lecture-room">
                <h2>207호 전산실습실</h2>
                <div className="image-container">
                  <div className="image c-room-image2"></div>
                </div>
                <p className="description">최대 수용인원: 30명</p>
                <p className="description">
                  주요 시설: 데스크톱 PC, 3D 설계 교육 장비, 전자교탁,
                  빔프로젝터, 마이크
                </p>
                <p className="description">사용문의: 041-354-8558</p>
              </div>
