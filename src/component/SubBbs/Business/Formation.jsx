                ...
                <div className='sub_banner_area'>
                    <div className='sub_banner_back'>
                        <div className='navi_text'>
                            <div className="home_icon"></div>{"> "}사업분야{" > "}산학지구조성사업
                        </div>
                        <div className='banner_main_text'>산학지구조성사업</div>
                    </div>
                            ...
                            <div className='founded_text_box formation'>
                                <div className='founded_text_row'>
                                    ...
                                    <div className='text_box'>
                                        <div className='text_row'> - 산업단지 캠퍼스 및 기업연구관 조성  </div>
                                    </div>
                                </div>
                                <div className='founded_text_row'>
                                    <div className='text_title'>근로자 평생학습 프로그램 </div>
                                    <div className='text_box'>
                                        <div className='text_row'>- 근로자가 일하며 배울 수 있는 학위, 비학위 과정 운영 </div>
                                        <div className='text_row'> - 마이스터고, 특성화고 학생이 산업단지 기업, 대학으로 취업 및 진학 연계 </div>
                                    </div>
                                </div>
                                <div className='founded_text_row'>
                                    <div className='text_title'>R&D 연계 맞춤형 교육 </div>
                                    <div className='text_box'>
                                        <div className='text_row'>- 현장맞춤형 기술/연구 인력 양성 및 취업/창업 연계지원 </div>
                                    </div>
                                </div>
                                <div className='founded_text_row'>
                                    <div className='text_title'>중소기업 연구개발 역량 강화</div>
                                    <div className='text_box'>
                                        <div className='text_row'> - 기업연구관 내에 중소, 중견기업 연구소 설치 및 R&D지원 </div>
                                        <div className='text_row'>- 대기업, 중소기업 협력 및 대학 연계형 교육 및 기술지원  </div>
                                    </div>
                                </div>
                                <div className='founded_text_row'>
                                    <div className='text_title'>산학융합형 교육 시스템 도입 </div>
                                    <div className='text_box'>
                                        <div className='text_row'>- 산학융합형 학위 및 교과 과정 개편  </div>
                                        <div className='text_row'>- 현장맞춤형 산업인력 양성 모델 반영</div>
                                    </div>
                                </div>
                            </div>
                        </div>
