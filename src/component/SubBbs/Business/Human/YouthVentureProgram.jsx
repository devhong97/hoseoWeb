...
import enterprise_img from "../../../../assets/image/youthVentureProgram_img.jpg";

const YouthVentureProgram = () => {
        ...
        <div className="navi_area">
          <div className="navi_back">
            ...
            <div className="navi_box human" onClick={() => handleSelect(2)}>
              <div className="navi_main_text">청년도전지원사업</div>
              <div className="navi_arrow"></div>
        ...
        <div className="sub_main_area temporary">
          <div className="sub_main_back image_box">
            <div className="fusionSupportProgram">
              <div className="youthVentureProgram_img"></div>
...
export default YouthVentureProgram;
