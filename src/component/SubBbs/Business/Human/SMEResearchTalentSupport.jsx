...
import enterprise_img from "../../../../assets/image/smeResearchTalentSupport_img.jpg";

const SMEResearchTalentSupport = () => {
        ...
        <div className="sub_main_area temporary">
          <div className="sub_main_back image_box">
            <div className="fusionSupportProgram">
              <div className="smeResearchTalentSupport_img"></div>
...
export default SMEResearchTalentSupport;
